...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/spark/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/spark/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Spark's existing visual language. Specifically:
