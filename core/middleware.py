...
INTERNAL_TOOL_TOKEN = os.environ.get("SPARK_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Spark-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Spark-Internal-Token), or
