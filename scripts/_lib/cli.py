"""scripts/_lib/cli.py — shared scaffolding for the `spark-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("spark-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/spark-foo`
...
VERSION = "0.1.0"  # bumped centrally; every spark-* CLI reports this
