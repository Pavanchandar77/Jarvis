...
COPILOT_USER_AGENT = os.environ.get(
    "SPARK_COPILOT_USER_AGENT", "Spark/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "SPARK_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "SPARK_COPILOT_EDITOR_VERSION", "Spark/1.0"
)
