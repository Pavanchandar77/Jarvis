...
COLLECTION_NAME = "spark_tool_index"
...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "semantic_twin": "Query the Semantic Twin (architecture graph) of a generated app: search, explain components, trace deps/execution, simulate changes, list projects. Prefer over re-parsing the whole repo.",
