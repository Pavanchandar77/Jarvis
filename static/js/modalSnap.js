...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'spark-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'spark-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('spark:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
