...
const LS_KEY = 'spark-theme';
const CUSTOM_THEMES_KEY = 'spark-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Spark Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'spark_' + (obj.name || 'theme') + '.json';
      a.click();
