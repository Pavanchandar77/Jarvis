"""`spark-research list --status complete` was returning nothing.
...
Part of #2122 (spark-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "spark-research"
    loader = importlib.machinery.SourceFileLoader("spark_research_cli", str(path))
